...
## Python inner working
    ...
    1. Compile to Byte Code
       1. Low level code
       2. Platfrom independent (Cloud, any OS)
       3. Byte code runs faster. (comparatively to script it runs faster)
       4. .pyc is compiled python (frozen binaries)
       5. __pycache__ => importance as python. learn more about this
